...
public class InitiativeTrackerThree {
...
/*
	// PRINT ENEMIES TO CONSOLE
	for(int i = 0; i < addEnemyLoops; i++) {
      System.out.println(charArray[i].name);
    }
*/
/*
...
*/
  ...
  public static Character[] addMultipleSameEnemy(Character[] charArray, int numOfCurrEnemies) {
    ...
    for(int i = 0; i < counter; i++) {
      ...
      //System.out.println(charArray[numOfCurrEnemies].name);
      numOfCurrEnemies++;
    }
  ...
  // ONLY ENTER DISTINCT CREATURES ONCE AND AUTOMATICALLY NUMBER
  // REPEATED CREATURES
